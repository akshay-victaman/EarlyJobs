...
const FranchiseWithUs = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0)
        document.title = metaConstants.franchiseWithUs.title
        ...
        <div className="partner-with-us-con">
            ...
            <div className='bde-sub-container'>
                <div className='bde-content-con'>
                    <h2 className='bde-sub-heading'>Fill the form below to Start your Business</h2>
                    <p className='bde-sub-text'>Please fill all the required fields to Start your Business</p>
