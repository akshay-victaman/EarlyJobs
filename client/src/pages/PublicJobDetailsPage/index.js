...
const PublicJobDetailsPage = ({ initialState }) => {
  // const initialState =
  //   typeof window !== "undefined" ? window.__INITIAL_STATE__ : null;
  const [jobDetails, setJobDetails] = useState(initialState?.jobData || {});
  ...
  useEffect(() => {
    if (document) {
      const title = `${jobDetails.role} in ${jobDetails.area} ${jobDetails.city} | Earlyjobs`;
          ...
          <div className="job-details-card">
            <div className="job-details-logo-title-con">
              ...
              <div className="job-details-apply-con">
                ...
                <button
                  className="public-job-apply-btn mobile-apply-btn-top"
            ...
            <div className="job-details-location-type-salary-con">
              ...
              <p
                className="job-details-location"
            ...
            <p className="job-detials-misc">
              <span className="misc-head">Salary:</span>{" "}
              {currency?.split(",")[0]}
              {minSalary} - {currency?.split(",")[0]}
            ...
            <div className="job-details-apply-con">
              <button
                className="public-job-apply-btn mobile-apply-btn"
                onClick={() => setApply(true)}
              >
                <IoMdPaperPlane className="apply-icon" /> Apply
              </button>
