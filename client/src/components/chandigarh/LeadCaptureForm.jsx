...
const LeadCaptureSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.send('service_93b2tt9', 'template_e91du1k', adminTemplateParams);
      await emailjs.send('service_93b2tt9', 'template_o7nrc4u', userTemplateParams);
  ...
  return (
    <>
      <Helmet>
        <title>Join EarlyJobs Chandigarh - Register for Career Opportunities</title>
        <meta
          name="description"
          content="Register with EarlyJobs Chandigarh for exclusive job opportunities, internships, and placement services. Connect with top employers in textile, manufacturing, and SME sectors."
        />
        <meta
          name="keywords"
          content="register jobs Chandigarh, career registration, job application Chandigarh, placement registration, internship application, hiring Chandigarh, recruitment form"
        />
        <meta property="og:title" content="Register - EarlyJobs Chandigarh Career Network" />
        <meta
          property="og:description"
          content="Join Chandigarh's premier career network. Quick registration process for students, colleges, and employers."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "ContactPage",
            "name": "EarlyJobs Chandigarh Registration",
            "description": "Register for career opportunities in Chandigarh",
            "contactPoint": {
              "@type": "ContactPoint",
