...
const ViewCompanies = ({ setShowCandidateForm, onShowCandidateDetails }) => {
  ...
  const candidates = new URLSearchParams(window.location.search).get(
    "candidates"
  );
  ...
  const handleUpdateCompany = async () => {
    ...
    const options = {
      ...
      body: JSON.stringify(
        file ? { ...companyDetails, companyLogoUrl: imageUrl } : companyDetails
      ),
    };
    try {
      setPopupLoading(true);
  ...
  const renderAddCompanyPopup = () => (
    <div className="bde-add-company-popup">
      ...
      <div className="bde-add-company-popup-content">
        ...
        <h1 className="bde-add-company-popup-heading">
  ...
  const renderCompanyDetailsPopup = () => {
    ...
    return (
      <div className="bde-add-company-popup">
        <div className="bde-add-company-popup-overlay"></div>
        <div
          className="bde-add-company-popup-content"
        ...
        >
          ...
          <div className="candidate-details-sub-con">
            <p className="candidate-details-sub-heading">
              Registered Address:{" "}
            </p>
  ...
  const renderCompanies = () => (
    <>
      <h1 className="bde-heading" style={{ textAlign: "center" }}>
        <span className="head-span">Companies</span>
      </h1>
      ...
      <div className="job-section-select-filter-container">
        ...
        <button
          className="login-button company-button"
          type="button"
          onClick={handleShowCompanyPopup}
        >
          Add Company
        </button>
      ...
      <div className="table-candidate-container">
        <table
          className={`job-details-candidates-table candidate-table-job-section ${
            companiesList.length === 0 ? "empty-candidates" : ""
          }`}
        >
              ...
              return (
                ...
                >
                  <td
                    ...
                    onClick={() => handleShowCompanyDetailsPopup(eachItem.id)}
                  >
                    {eachItem.name}
                  </td>
                  <td className="job-details-candidates-table-cell">
                    {eachItem.registeredAddress}
                  </td>
                  <td className="job-details-candidates-table-cell">
                    {eachItem.email}
                  </td>
                  ...
                  <td className="job-details-candidates-table-cell">
                    <button
                      ...
                      onClick={() => handleShowCompanyJobs(eachItem.id)}
                    >
                      View
                    </button>
                  </td>
                  <td className="job-details-candidates-table-cell">
                    <button
                      className="block-user-button"
                      onClick={() =>
                        handleShowCompanyCandidates(eachItem.id, eachItem.name)
                      }
                    >
                      View
                    </button>
                  ...
                  <td className="job-details-candidates-table-cell">
                    <button
                      className="block-user-button"
                      onClick={() =>
                        handleShowTenureApprovedCandidates(
                          eachItem.id,
                          eachItem.name
                        )
                      }
                  ...
                  <td className="job-details-candidates-table-cell">
                    <button
                      className="block-user-button"
                      onClick={() =>
                        handleShowCompanyPopup(eachItem.id, "update")
                      }
                    >
                      Update
                    </button>
        ...
        {companiesList.length === 0 && (
          <p className="no-candidates-error">{renderNoCompanies()}</p>
        )}
      </div>
    ...
    return (
      <div className="company-job-list-con">
        {noJobs ? (
          ...
          <>
            <h1 className="company-jobs-heading">
              {companyJobList[0].compname}
            </h1>
  ...
  return (
    ...
    >
      {showCompanyJobs === 1 ? (
        ...
        <CompanyCandidates
          handleHideCompanyJobs={handleHideCompanyJobs}
          onShowCandidateDetails={onShowCandidateDetails}
          companyId={companyId}
          companyName={companyName}
        />
      ) : (
        <TenureApprovedCompanyCandidates
          handleHideCompanyJobs={handleHideCompanyJobs}
          onShowCandidateDetails={onShowCandidateDetails}
          companyId={companyId}
          companyName={companyName}
