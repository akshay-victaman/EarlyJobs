...
const BDEPage = () => {
  ...
  const onRemoveSkills = (id) => {
    setPostNewJob({
      ...postNewJob,
      skills: postNewJob.skills.filter((skill) => skill.id !== id),
    });
  };
  ...
  const validate = () => {
    const errors = {
      ...
      salary:
        ...
        parseInt(postNewJob.salaryMin) < 0 ||
        parseInt(postNewJob.salaryMax) < 0 ||
        parseInt(postNewJob.salaryMin) > parseInt(postNewJob.salaryMax),
      ...
      commission:
        postNewJob.commission.trim().length === 0 ||
        postNewJob.commissionType.trim().length === 0 ||
        parseInt(postNewJob.commission) < 0 ||
        (postNewJob.commissionType === "Percentage" &&
          parseInt(postNewJob.commission) > 100),
      tenureInDays:
        parseInt(postNewJob.tenureInDays) < 0 ||
        postNewJob.tenureInDays.trim().length === 0,
      noOfOpenings:
        postNewJob.noOfOpenings.trim().length === 0 ||
        parseInt(postNewJob.noOfOpenings) <= 0,
      ...
      minExperience:
        parseInt(postNewJob.minExperience) < 0 ||
        postNewJob.minExperience.length === 0 ||
        parseInt(postNewJob.minExperience) > parseInt(postNewJob.maxExperience),
      maxExperience:
        parseInt(postNewJob.maxExperience) < 0 ||
        postNewJob.maxExperience.length === 0 ||
        parseInt(postNewJob.maxExperience) < parseInt(postNewJob.minExperience),
      minAge:
        parseInt(postNewJob.minAge) < 18 ||
        postNewJob.minAge.trim().length === 0 ||
        parseInt(postNewJob.minAge) > parseInt(postNewJob.maxAge),
      maxAge:
        parseInt(postNewJob.maxAge) < 18 ||
        postNewJob.maxAge.trim().length === 0 ||
        parseInt(postNewJob.maxAge) < parseInt(postNewJob.minAge),
    };
  ...
  const renderJobForm = () => (
    <form className="bde-job-form" onSubmit={handlePostJob}>
      ...
      <EditorComponent
        content={postNewJob.jobDescription}
      ...
      <div className="salary-container">
        <div className="emp-work-sub-con">
          ...
          <input
            ...
            id="streetAddress"
            onChange={handleInputChange}
            value={postNewJob.streetAddress}
            name="streetAddress"
            type="text"
      ...
      <div className="salary-container">
        <input
          ...
          style={{ width: "10%" }}
          onChange={handleInputChange}
          value={postNewJob.salaryMin}
          name="salaryMin"
          type="number"
          placeholder={`Minimum - ${postNewJob.currency.split(",")[1]}`}
        />
        <input
          className="bde-form-input salary-input"
          id="salary"
          style={{ width: "40%" }}
          onChange={handleInputChange}
          value={postNewJob.salaryMax}
          name="salaryMax"
          type="number"
          placeholder={`Maximum - ${postNewJob.currency.split(",")[1]}`}
        />
      </div>
      {salaryError && (
        <p className="hr-error">
      ...
      <div className="salary-container">
        <select
          ...
          onChange={handleInputChange}
          value={postNewJob.commissionType}
          name="commissionType"
        >
        ...
        <div className="commission-input-con">
          ...
          <input
            ...
            type="number"
            onChange={handleInputChange}
            value={postNewJob.commission}
            name="commission"
            placeholder={
              postNewJob.commissionType === "Fixed" ? "5500" : "8.33"
            }
          />
      ...
      <div className="salary-container">
        <div className="emp-work-sub-con">
          ...
          <select
            ...
            id="min-qual"
            name="qualification"
            value={postNewJob.qualification}
            onChange={handleInputChange}
          >
        ...
        <div className="emp-work-sub-con">
          ...
          <div className="experience-sub-con">
            <input
              ...
              type="number"
              onChange={handleInputChange}
              value={postNewJob.minExperience}
              name="minExperience"
              placeholder="Min"
            />
            <input
              ...
              type="number"
              onChange={handleInputChange}
              value={postNewJob.maxExperience}
              name="maxExperience"
              placeholder="Max"
            />
          </div>
      ...
      <div className="hr-input-list-con">
        {postNewJob.assignedTo.map((email, index) => {
          const hiringManagerName = accountManagers.find(
      ...
      <div className="bde-container">
        <div className="bde-content">
          <h1 className="bde-heading">
            Welcome to{" "}
            <span className="head-span">Business Development Executive</span>{" "}
            Portal
          </h1>
